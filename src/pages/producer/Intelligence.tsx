      ...
      <div className="p-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            AI-powered market insights and competitive analysis for informed decision-making
          </p>
        </div>
        ...
        <Tabs defaultValue="trends" className="space-y-6">
          ...
          <TabsContent value="trends">
            <Card className="glass p-6">
              ...
              <p className="text-muted-foreground mb-6">
                Get insights into current market trends, successful releases, and audience preferences
              </p>
          ...
          <TabsContent value="predictions">
            <Card className="glass p-6">
              ...
              <p className="text-muted-foreground mb-6">
                Forecast future trends and identify emerging opportunities in specific genres
              </p>
              <div className="space-y-4 mb-6">
                <div>
                  <label className="text-sm font-medium mb-2 block">Genre</label>
          ...
          <TabsContent value="competitive">
            <Card className="glass p-6">
              ...
              <p className="text-muted-foreground mb-6">
                Understand the competitive landscape and identify strategic positioning opportunities
              </p>
              <div className="space-y-4 mb-6">
                <div>
                  <label className="text-sm font-medium mb-2 block">Genre</label>
